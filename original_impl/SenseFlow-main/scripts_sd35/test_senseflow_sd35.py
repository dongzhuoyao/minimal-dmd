...
if __name__ == "__main__":
    seed_everything(42)
    parser = argparse.ArgumentParser(description="Inference script for SenseFlow SD3.5 Medium model")
    parser.add_argument("--sd35_ckpt", type=str, required=True,
                        help="Path to Stable Diffusion 3.5 Medium checkpoint directory")
